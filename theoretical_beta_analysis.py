...
def main(args):
	...
	resultsPath = os.path.join(config.DIR_NAME, "theoretical_beta_analysis_%s_%s_branches_%s_with_overhead_with_nano_with_test_set_FINAL_FINAL_FINAL.csv"%(args.model_name, args.n_branches, args.model_id))
