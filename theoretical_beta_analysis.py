...
def main(args):
	...
	global_ts_path = os.path.join(config.DIR_NAME, "alternative_temperature_%s_%s_branches_id_%s_rodrigo_version.csv"%(args.model_name, args.n_branches, args.model_id))

	threshold_list = [0.7, 0.8, 0.85]
