...
def main(args):
	...
	resultsPath = os.path.join(config.DIR_NAME, "experimental_beta_analysis_%s_%s_branches_overhead_%s_rodrigo_version_test_test_alt_2.csv"%(args.model_name, args.n_branches, args.overhead))
