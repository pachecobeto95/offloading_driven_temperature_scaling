...
def main(args):
	...
	resultsPath = os.path.join(config.DIR_NAME, "overall_acc_adaTS_%s_%s_branches_%s_with_overhead_with_nano_pos_1_review_%s.csv"%(args.model_name, args.n_branches, args.model_id, mode))
