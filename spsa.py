...
def theoretical_beta_function(temp_list, n_branches, max_exits, threshold, df, df_device, beta, overhead, mode):
	...
	inf_time_current2, _ = compute_inference_time_multi_branches2(temp_list, n_branches, max_exits, threshold, df, df_device, overhead)

	print(inf_time_current, inf_time_current2)
...
def compute_inference_time_multi_branches2(temp_list, n_branches, max_exits, threshold, df, df_device, overhead):
	...
	for i in range(n_branches):
		...
		inf_time_branch_device = df_device["delta_inferente_time_branch_%s"%(i+1)].mean()
